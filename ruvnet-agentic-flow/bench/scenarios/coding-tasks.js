...
const tasks = [
  ...
  return [...new Set(arr)];
        ...
        successCriteria: (result) => {
            ...
            return (code.includes('set') ||
                (code.includes('filter') && code.includes('indexof'))) && !result.output.includes('TODO');
        },
        difficulty: 'easy'
    },
    {
  ...
  // TODO: implement
        ...
        successCriteria: (result) => {
            const code = result.output.toLowerCase();
            return (code.includes('settimeout') &&
  ...
  // TODO: implement, return -1 if not found
        ...
        successCriteria: (result) => {
            const code = result.output.toLowerCase();
            return ((code.includes('while') || code.includes('recursive')) &&
                code.includes('mid') &&
                code.includes('left') &&
                code.includes('right') &&
                !result.output.includes('TODO'));
  ...
  // TODO: implement
        ...
        successCriteria: (result) => {
            const code = result.output.toLowerCase();
            return ((code.includes('flat') || code.includes('reduce') || code.includes('recursive')) &&
  ...
  // TODO: implement
        ...
        successCriteria: (result) => {
            const code = result.output.toLowerCase();
            return ((code.includes('map') || code.includes('cache')) &&
                code.includes('has') &&
                code.includes('get') &&
                code.includes('set') &&
                !result.output.includes('TODO'));
...
export const codingTasksScenario = {
    name: 'coding-tasks',
