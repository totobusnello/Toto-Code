...
const tasks = [
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return ((output.includes('cursor') || output.includes('offset')) &&
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return ((output.includes('x-ratelimit-limit') || output.includes('rate limit')) &&
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return ((output.includes('/v1') || output.includes('/v2')) ||
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return (output.includes('multipart') ||
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return ((output.includes('q=') || output.includes('query=') || output.includes('search=')) &&
    ...
    },
    {
        ...
        successCriteria: (result) => {
            const output = result.output.toLowerCase();
            return (output.includes('webhook') &&
...
export const apiDesignTasksScenario = {
