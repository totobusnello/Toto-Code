...
- ✅ **Main entry**: `agentic-flow/dist/index.js`
- ✅ **Types**: `agentic-flow/dist/index.d.ts`
- ✅ **Bin entries**:
  - `agentic-flow` → CLI proxy
  - `agentdb` → AgentDB CLI
...
- ✅ **PeerDependencies**: Optional claude-flow, flow-nexus
...
- ✅ **CLI**: Bin entries for agentic-flow and agentdb
